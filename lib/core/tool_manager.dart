...
class ToolManager {
  static const String TOOLS_REPO_URL =
      'https://github.com/yourusername/wimax-tools/raw/main/tools/';
  static const List<String> REQUIRED_TOOLS = [
    'tcpdump',
    'arpspoof',
    'aircrack-ng',
    'reaver',
  ...
  Future<Directory> getToolsDirectory() async {
    ...
    final toolsDir = Directory('${dir.path}/tools')
