...
class DnsSpoofModule {
  ...
  Future<void> startDnsSpoof({
    required String targetIp,
    required String spoofedDomain,
    required String fakeIp,
  }) async {
    final hostsEntry = "$fakeIp $spoofedDomain\n";
    final hostsFile = File("/data/local/tmp/hosts")
      ..writeAsString(hostsEntry, mode: FileMode.append);
