...
import 'package:wimax_flutter/modules/dns_spoof.dart';
...
class _DnsSpoofScreenState extends State<DnsSpoofScreen> {
  ...
  Future<void> _startAttack() async {
    ...
    await _dnsSpoof.startDnsSpoof(targetIp: targetIp, spoofedDomain: domain, fakeIp: fakeIp);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            TextField(controller: _targetController, decoration: InputDecoration(labelText: 'IP الهدف')),
            TextField(controller: _domainController, decoration: InputDecoration(labelText: 'المجال المزيف')),
            TextField(controller: _fakeIpController, decoration: InputDecoration(labelText: 'IP المزيف')),
