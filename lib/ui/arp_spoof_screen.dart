...
import 'package:wimax_flutter/modules/arp_spoof.dart';
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                ElevatedButton.icon(onPressed: _isRunning ? null : _startAttack, icon: Icon(Icons.play_arrow), label: Text('بدء')),
                ElevatedButton.icon(onPressed: _isRunning ? null : _stopAttack, icon: Icon(Icons.stop), label: Text('إيقاف')),
              ],
            ),
          ],
        ),
